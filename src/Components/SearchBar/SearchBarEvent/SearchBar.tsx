...
export function SearchBar({
  ...
  const handleSearch = (e) => {
    ...
    console.log("Lettres prises en compte :", e.target.value);
    filteredPosts(e.target.value);
    console.log(filteredPosts());
  };

  const handleFilterFuturePosts = () => {
    const futurePosts = onFilterFuturePosts();
    console.log(futurePosts);
  };

  const handleFilterPastPosts = () => {
    const pastPosts = onFilterPastPosts();
  ...
  const navList = (
    <ul className="mt-2 mb-4 flex flex-col gap-2 lg:mb-0 lg:mt-0 lg:flex-row lg:items-center lg:gap-6">
      ...
      >
        <a
          href="#"
          onClick={handleFilterFuturePosts}
          className="flex items-center"
        >
          A venir
        </a>
